                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xxl-6 col-md-7">
                            ...
                            <p className="text-lg mb-50 pt-40 pe-xl-5 md-pt-30 md-mb-40">Abacies delivered blazing fast, striking ai solution lorem quis data user learning analysis.</p>

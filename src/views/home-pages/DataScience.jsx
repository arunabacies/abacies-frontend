                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-4 col-lg-4">
                                ...
                                {/* /.title-style-one */}
                                <p className="sub-heading mt-25 mb-50 md-mb-20">Abacies is data science, machine learning &amp; artificial intelligence.</p>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-5 col-md-6">
                                <div className="block-style-two pe-xxl-5" data-aos="fade-right">
                                    ...
                                    {/* /.title-style-one */}
                                    <p className="pt-20 pb-30 lg-pb-10">Abacies is data science, machine learning and

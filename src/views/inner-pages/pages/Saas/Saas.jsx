    ...
    return (
        <Fragment>
            <div className="main-page-wrapper">
                <Helmet>
                    <title>Saas || Abacies - Data Science & Analytics React Template</title>
                </Helmet>
                {/* helmet end */}
                ...
                <div className="theme-inner-banner">
                    <InnerBanner intro="Shaping the Ever-evolving Digital Enterprise" currpage="Saas"/>
                ...
                <div
                    ...
                    <div className="container">
                        <div className="title-style-one text-center">
                            <h2 className="main-title">Embracing SaaS: The Big Pivot Strategy</h2>
                        </div>
                        {/* /.title-style-one */}
                    </div>
                    {/* /.container */}
                    <div className="inner-content mt-90 lg-mt-60">
                        <div className="container">
                            <div className="slider-wrapper">
                                <p>Shifting to SaaS is a long and complex journey, as the shift is not limited to IT restructuring. It also requires a change in mindset—a cultural change that effectively addresses the impact of adopting SaaS on key business processes, IT infrastructure, and people. </p> 
                                <p>At HCLTech, we function as a Digital Challenger to help organizations embark on their SaaS journey and capture the full value of the operating model. As a catalyst of change, we assess how their SaaS strategy will challenge the status quo of different processes—identifying the opportunities and complexities to help IT teams reorganize around business value chains. It follows with the dissemination of change through: </p>
                                <ul>
                                    <li><strong>Digital consulting</strong> to rethink their operating model, organize for agility, and grow an agile mindset. </li>
                                    <li><strong>Apps & platforms</strong> Apps & platforms </li>
                                    <li><strong>Data and analytics</strong> to generate insight into iterations/improvements</li>
                                </ul>
                                <p>Put simply, the core of driving SaaS strategy at HCLTech is identifying the right experience, enabling it with the right platforms, and optimizing with the right data-driven insights.</p>
                            </div>
                        </div>
                        {/* /.slider-wrapper */}
                    </div>
